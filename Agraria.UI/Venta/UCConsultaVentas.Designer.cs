...
{
    partial class UCConsultaVentas
    {
        /// <summary> 
		...
		private void InitializeComponent()
		{
			...
			BtnImprimir.Size = new Size(65, 44);
			...
			LblIdRemito.Location = new Point(130, 11);
			...
			tableLayoutPanel9.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 34.0482559F));
			tableLayoutPanel9.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 65.9517441F));
			...
			label4.Location = new Point(64, 4);
			label4.Name = "label4";
			...
			LblFecha.Location = new Point(129, 4);
			...
			tableLayoutPanel10.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 33.5120659F));
			tableLayoutPanel10.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 66.48794F));
			tableLayoutPanel10.Controls.Add(LblDescripcion, 1, 0);
			tableLayoutPanel10.Controls.Add(label6, 0, 0);
			tableLayoutPanel10.Dock = DockStyle.Fill;
			tableLayoutPanel10.ForeColor = Color.White;
			...
			LblDescripcion.Location = new Point(128, 4);
			...
			Name = "UCConsultaVentas";
			Padding = new Padding(16);
			Size = new Size(804, 561);
			Load += UCConsultaVentas_Load;
			VisibleChanged += UCConsultaVentas_VisibleChanged;
