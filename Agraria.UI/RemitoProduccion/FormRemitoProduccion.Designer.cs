...
{
    partial class FormRemitoProduccion
    {
        /// <summary>
		...
		private void InitializeComponent()
		{
			...
			BtnOpcionEditar.Text = "Consultar Orden de Producción";
			...
			BtnOpcionIngresar.Text = "Ingresar Orden de Producción";
			...
			Name = "FormRemitoProduccion";
			Text = "FormRemitoProduccion";
			FormClosing += FormRemitoProduccion_FormClosing;
			Load += FormRemitoProduccion_Load;
