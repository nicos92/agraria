namespace Agraria.UI.RemitoProduccion
{
    partial class UCConsultaRemitos
    {
		...
		private void InitializeComponent()
		{
			...
			GBLista.Text = "Lista de ordenes de producción";
			// 
			// tableLayoutPanel1
			// 
			...
			DtpFechaDesde.Size = new Size(108, 29);
			...
			DtpFechaHasta.Location = new Point(254, 3);
			DtpFechaHasta.Name = "DtpFechaHasta";
			DtpFechaHasta.Size = new Size(108, 29);
			...
			TxtIdRemito.Location = new Point(254, 38);
			TxtIdRemito.Name = "TxtIdRemito";
			TxtIdRemito.Size = new Size(108, 29);
			...
			label5.Location = new Point(192, 42);
			label5.Name = "label5";
			...
			BtnBuscar.Location = new Point(213, 85);
			...
			GBForm.Text = "Orden de producción";
			// 
			// tableLayoutPanel3
			// 
			...
			label14.Location = new Point(127, 2);
			...
			tableLayoutPanel8.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 40.43321F));
			tableLayoutPanel8.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 59.5667877F));
			...
			BtnImprimir.BackColor = Color.FromArgb(186, 26, 26);
			...
			BtnImprimir.Location = new Point(308, 0);
			BtnImprimir.Margin = new Padding(0);
			BtnImprimir.Name = "BtnImprimir";
			BtnImprimir.Size = new Size(65, 42);
			...
			LblIdRemito.Location = new Point(127, 10);
			...
			tableLayoutPanel9.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 34.58445F));
			tableLayoutPanel9.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 65.41555F));
			...
			LblFecha.Location = new Point(132, 2);
			...
			tableLayoutPanel10.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 34.3163528F));
			tableLayoutPanel10.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 65.68365F));
			...
			LblDescripcion.Location = new Point(131, 2);
			...
			tableLayoutPanel11.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 34.3163528F));
			tableLayoutPanel11.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 65.68365F));
			...
			label8.Location = new Point(46, 1);
			label8.Name = "label8";
			...
			LblUsuario.Location = new Point(131, 1);
