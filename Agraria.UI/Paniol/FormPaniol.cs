...
namespace Agraria.UI.Paniol
{
    ...
    public partial class FormPaniol: Form
    {
        private Button _btnActual;
        private readonly IServiceProvider _serviceProvider;
        public FormPaniol(IServiceProvider serviceProvider)
        {
        ...
        {
            BtnOpcionIngresar.Tag = typeof(UCIngresoHerramienta);
            BtnOpcionEditar.Tag = typeof(UCConsultaHerramienta);
