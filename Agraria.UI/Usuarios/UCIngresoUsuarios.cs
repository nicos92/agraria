...
namespace Agraria.UI.Usuarios
{
	public partial class UCIngresoUsuarios : UserControl
	{
		...
		{
			BtnIngresar.Enabled = ValidadorMultiple.ValidacionMultiple(_vTxtDni, _vTxtApellido, _vTxtNombre, _vTxtTel, _vTxtEmail, _vTxtContra, _vTxtContraDos, _vTxtRespues) && TxtContra.Text == TxtContraDos.Text;
