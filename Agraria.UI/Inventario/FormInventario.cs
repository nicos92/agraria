...
namespace Agraria.UI.Inventario
{
    public partial class FormInventario : Form
    {
        ...
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="FormInventario"/>.
        /// </summary>
        /// <param name="serviceProvider">El proveedor de servicios para la inyección de dependencias.</param>
        public FormInventario(IServiceProvider serviceProvider)
        {
        ...
        {
            BtnOpcionIngresar.Tag = typeof(UCIngresoInventario);
            BtnOpcionEditar.Tag = typeof(UCConsultaInventario);
