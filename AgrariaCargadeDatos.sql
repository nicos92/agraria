...
INSERT INTO ArticulosGral (Art_Cod, Art_Nombre, Art_Unidad_Medida, Art_Precio, Art_Descripcion, Art_Stock) VALUES
('A0000003', 'Leche entera', 1, 150.00, 'Ingrediente principal para dulce de leche', 20),
('A0000004', 'Azúcar', 2, 80.00, 'Azúcar para repostería y cocina', 50),
('A0000005', 'Bicarbonato de sodio', 3, 20.00, 'Ayuda a la consistencia del dulce de leche', 15),
('A0000006', 'Vinagre de alcohol', 1, 60.00, 'Para escabeches y conservas', 10),
('A0000007', 'Aceite de girasol', 1, 120.00, 'Aceite de cocina multiuso', 30),
('A0000008', 'Cebolla', 2, 50.00, 'Base de guisos y escabeches', 40),
('A0000009', 'Zanahoria', 2, 45.00, 'Vegetal para guisos y ensaladas', 35),
('A0000010', 'Ajo', 2, 30.00, 'Saborizante esencial en muchas comidas', 25),
('A0000011', 'Harina 0000', 2, 70.00, 'Para masas de empanadas y pasteles', 60),
('A0000012', 'Grasa bovina', 2, 95.00, 'Para masa de empanadas criollas', 15),
('A0000013', 'Carne picada', 2, 250.00, 'Relleno clásico de empanadas', 25),
('A0000014', 'Pimentón dulce', 3, 40.00, 'Condimento para el relleno', 12),
('A0000015', 'Comino en polvo', 3, 35.00, 'Aporta sabor a las carnes', 8),
('A0000016', 'Sal fina', 3, 15.00, 'Sal de mesa y para cocinar', 80),
('A0000017', 'Huevos de gallina', 1, 90.00, 'Ingrediente para muchas recetas', 50),
('A0000018', 'Aceitunas verdes', 3, 65.00, 'Para rellenos de empanadas', 10),
('A0000019', 'Pan rallado', 2, 55.00, 'Para rebozar milanesas', 30),
('A0000020', 'Tomate triturado', 1, 85.00, 'Para salsas de pasta y pizza', 20),
('A0000021', 'Queso mozzarella', 2, 300.00, 'Para pizzas y gratinados', 15),
('A0000022', 'Levadura fresca', 3, 25.00, 'Para masas de pan y pizza', 10),
('A0000023', 'Jamón cocido', 2, 280.00, 'Embutido para sándwiches y rellenos', 18),
('A0000024', 'Atún en lata', 1, 110.00, 'Para ensaladas y tartas', 25),
('A0000025', 'Mayonesa', 1, 75.00, 'Aderezo para ensaladas y sándwiches', 22),
('A0000026', 'Mostaza', 1, 60.00, 'Aderezo picante', 15),
('A0000027', 'Papas', 2, 40.00, 'Para puré, fritas y guarniciones', 60),
('A0000028', 'Arroz blanco', 2, 90.00, 'Cereal básico', 45),
('A0000029', 'Fideos spaghetti', 2, 85.00, 'Pasta para platos principales', 50),
('A0000030', 'Lentejas secas', 2, 70.00, 'Para guisos y estofados', 20),
('A0000031', 'Garbanzos en conserva', 1, 65.00, 'Para ensaladas o hummus', 10),
('A0000032', 'Agua mineral', 1, 50.00, 'Agua embotellada para consumo', 100),
('A0000033', 'Gaseosa cola', 1, 90.00, 'Bebida carbonatada', 80),
('A0000034', 'Jugo de naranja', 1, 100.00, 'Bebida de frutas', 40),
('A0000035', 'Leche de almendras', 1, 180.00, 'Bebida vegetal', 15),
('A0000036', 'Café en grano', 2, 350.00, 'Para preparar café', 12),
('A0000037', 'Té en saquitos', 1, 120.00, 'Para infusiones', 25),
('A0000038', 'Pan lactal', 1, 80.00, 'Pan de molde para sándwiches', 30),
('A0000039', 'Mermelada de durazno', 1, 90.00, 'Para desayunos y postres', 15),
('A0000040', 'Cereal de maíz', 2, 130.00, 'Para el desayuno', 20),
('A0000041', 'Yogur de vainilla', 1, 60.00, 'Postre lácteo', 40),
('A0000042', 'Galletitas dulces', 1, 75.00, 'Para la merienda', 50),
('A0000043', 'Chocolate en barra', 1, 100.00, 'Para postres y consumo directo', 25),
('A0000044', 'Frutillas', 2, 180.00, 'Fruta para postres', 10),
('A0000045', 'Manzanas', 2, 100.00, 'Fruta de consumo diario', 30),
('A0000046', 'Bananas', 2, 95.00, 'Fuente de potasio', 25),
('A0000047', 'Limones', 2, 60.00, 'Para jugos y aderezos', 20),
('A0000048', 'Naranjas', 2, 80.00, 'Para jugos y consumo', 30),
('A0000049', 'Lechuga', 1, 55.00, 'Para ensaladas', 15),
('A0000050', 'Tomates', 2, 70.00, 'Para ensaladas y salsas', 20),
('A0000051', 'Pepinos', 2, 65.00, 'Para ensaladas y conservas', 12),
('A0000052', 'Pollo entero', 2, 150.00, 'Carne de ave', 10),
('A0000053', 'Pescado filete', 2, 350.00, 'Proteína de pescado', 8),
('A0000054', 'Carne de cerdo', 2, 280.00, 'Para asado y guisos', 7),
('A0000055', 'Salchichas', 1, 120.00, 'Embutido para hot dogs', 15),
('A0000056', 'Queso rallado', 3, 90.00, 'Para pastas y ensaladas', 18),
('A0000057', 'Pimienta negra molida', 3, 45.00, 'Condimento básico', 10),
('A0000058', 'Orégano seco', 3, 30.00, 'Hierba para pizzas y salsas', 9),
('A0000059', 'Laurel', 3, 25.00, 'Hoja para dar sabor a caldos', 5),
('A0000060', 'Aceitunas negras', 3, 70.00, 'Para pizzas y aperitivos', 8),
('A0000061', 'Jamonada', 1, 150.00, 'Fiambrera para sándwiches', 10),
('A0000062', 'Azúcar impalpable', 2, 95.00, 'Para decorar postres', 5),
('A0000063', 'Dulce de membrillo', 1, 110.00, 'Para postres y pasteles', 7),
('A0000064', 'Crema de leche', 1, 80.00, 'Para salsas y postres', 15),
('A0000065', 'Gelatina sin sabor', 3, 30.00, 'Para postres y moldes', 10),
('A0000066', 'Vainilla en esencia', 1, 40.00, 'Aromatizante para repostería', 12),
('A0000067', 'Polvo de hornear', 3, 25.00, 'Para que las masas suban', 15),
('A0000068', 'Cacao en polvo', 3, 85.00, 'Para postres y bebidas', 10),
('A0000069', 'Maicena', 2, 60.00, 'Espesante para salsas y cremas', 20),
('A0000070', 'Fideos secos', 2, 80.00, 'Pasta para caldos y sopas', 25),
('A0000071', 'Vinagre de manzana', 1, 70.00, 'Para ensaladas y aderezos', 10),
('A0000072', 'Aceite de oliva extra virgen', 1, 250.00, 'Aceite de alta calidad', 8),
('A0000073', 'Salsa de soja', 1, 120.00, 'Condimento oriental', 10),
('A0000074', 'Miel pura', 1, 180.00, 'Endulzante natural', 5),
('A0000075', 'Maní sin cáscara', 2, 100.00, 'Para snacks y postres', 15),
('A0000076', 'Almendras', 2, 300.00, 'Fruto seco para repostería', 10),
('A0000077', 'Pasas de uva', 2, 90.00, 'Fruta deshidratada', 8),
('A0000078', 'Arvejas en lata', 1, 55.00, 'Para ensaladas y guisos', 20),
('A0000079', 'Choclo en lata', 1, 60.00, 'Maíz para ensaladas', 18),
('A0000080', 'Porotos', 2, 85.00, 'Legumbre para guisos', 15),
('A0000081', 'Salchicha parrillera', 2, 150.00, 'Embutido para asados', 10),
('A0000082', 'Chorizo', 2, 180.00, 'Para asados y guisos', 8),
('A0000083', 'Panceta ahumada', 2, 220.00, 'Para cocinar y guisos', 5),
('A0000084', 'Mortadela', 2, 160.00, 'Para sándwiches', 12),
('A0000085', 'Queso de sándwich', 1, 200.00, 'Queso en fetas', 15),
('A0000086', 'Manteca', 2, 95.00, 'Para cocinar y untar', 20),
('A0000087', 'Crema pastelera', 1, 130.00, 'Para rellenar pasteles', 10),
('A0000088', 'Dulce de leche repostero', 1, 180.00, 'Para rellenar tortas y pasteles', 8),
('A0000089', 'Harina de maíz', 2, 75.00, 'Para arepas y polenta', 15),
('A0000090', 'Polenta', 2, 60.00, 'Comida a base de maíz', 10),
('A0000091', 'Especias surtidas', 1, 150.00, 'Mezcla de especias para condimento', 5),
('A0000092', 'Salsa de tomate', 1, 80.00, 'Salsa para pastas y pizzas', 20),
('A0000093', 'Agua tónica', 1, 70.00, 'Bebida carbonatada', 15),
('A0000094', 'Té verde en saquitos', 1, 100.00, 'Infusión saludable', 10),
('A0000095', 'Jugo de manzana', 1, 95.00, 'Bebida de frutas', 12),
('A0000096', 'Leche descremada', 1, 140.00, 'Leche con menos grasa', 18),
('A0000097', 'Galletitas saladas', 1, 65.00, 'Para picadas y aperitivos', 25),
('A0000098', 'Pan integral', 1, 90.00, 'Opción más saludable de pan', 20),
('A0000099', 'Tomate cherry', 2, 120.00, 'Para ensaladas y decoración', 10),
('A0000100', 'Palta (Aguacate)', 2, 200.00, 'Para ensaladas y guacamole', 10),
('A0000101', 'Vinagre de vino', 1, 80.00, 'Para aderezos y conservas', 10),
('A0000102', 'Bolsas de residuo', 1, 50.00, 'Articulo de limpieza', 25);
