namespace Agraria.Login
{
    partial class FormRecuperarContra
    {
        ...
        private void InitializeComponent()
        {
            ...
            TLPInicio.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 19.9828873F));
            TLPInicio.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 63.5430031F));
            TLPInicio.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 16.4741135F));
            ...
            TLPInicio.Controls.Add(TxtRespues, 1, 12);
            TLPInicio.Controls.Add(label4, 1, 11);
